...
function Carousel({
    ...
    return (
        ...
        <div className="flex  justify-center mx-auto items-center">
            ...
            <div style={style} className="px-5 mx-auto flex w-[100%] md:w-full  box overflow-hidden justify-start  py-20 items-start flex-col lg:flex-row ">

                <div

                    className="section-right h-auto  w-full lg:w-1/2  pl-5 md:pl-20"
                ...
                <div className="section-left w-full lg:w-1/2 px-0 md:px-10 flex justify-between flex-col">
                    ...
                    <motion.div className="dark:bg-black bg-gray-100 " initial='initial' animate='animate' exit={{ opacity: 0 }}>
                        <motion.div variants={stagger} className='inner w-full pr-2'>
                            ...
                            <motion.p className="dark: text-slate-300 " variants={fadeInUp}>
                                ...
                                <div className="btn-wrap flex flex-col md:flex-row ">
                                    <ModalBtn/>
                                    <ModalBtn01 />
                                </div>
                                {/* <CelebrateBTN/> */}
