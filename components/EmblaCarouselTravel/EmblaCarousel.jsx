      ...
      <div className="embla__viewport overflow-hidden" ref={emblaRef}>
        ...
        >
          {slides.map((slide, index) => (
            ...
            >
              <div
                className="embla__slide__number overflow-hidden border-none md:border bg-[#ffffff]  pb-8 md:border-black flex flex-col items-center justify-center font-semibold"
                style={{
