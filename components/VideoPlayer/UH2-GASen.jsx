...
const VideoPlayer = () => {
  const videoUrl = 'https://www.ultraehp.com/images/Ultra Video/UH2-gas/英文版/UH2-gas英文版.mp4'; // Path to your local video file

  const posterUrl = 'https://www.ultraehp.com/images/Ultra Video/UH2-gas/英文版/YouTube-UH2-gas-英文.jpg'; // Path to your video poster image
