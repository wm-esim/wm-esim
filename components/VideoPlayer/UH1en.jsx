...
const VideoPlayer = () => {
  const videoUrl = 'https://www.ultraehp.com/images/Ultra Video/UH1/英文版/UH1英文版.mp4'; // Path to your local video file

  const posterUrl = 'https://www.ultraehp.com/images/Ultra Video/UH1/英文版/YouTube-UH1-英文.jpg'; // Path to your video poster image
