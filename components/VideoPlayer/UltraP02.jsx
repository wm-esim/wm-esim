...
const VideoPlayer = () => {
  const videoUrl = 'https://www.ultraehp.com/images/Ultra Video/UX200/中文版/UX200中文版.mp4'; // Path to your local video file

  const posterUrl = 'https://www.ultraehp.com/images/Ultra Video/UX200/中文版/YouTube-UX200-中文.webp'; // Path to your video poster image
