  ...
  return (
    <div className="group block ">
      ...
      <Modal
        ...
        size="full"
        className="flex items-center !z-[999999999999] justify-center !rounded-[27px] min-h-auto !h-auto !min-h-auto"
      >
        <ModalContent className="w-full max-w-7xl  2xl:p-10 md:p-5 p-0">
          <ModalBody className="  max-w-[1200px] mx-auto rounded-[27px] w-[90%]">
            {selectedProduct && (
              <EasyProduct
